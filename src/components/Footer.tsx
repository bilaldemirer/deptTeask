                    ...
                    <div className="mt-5 mb-5">
                        ...
                        <div className="mt-5 mb-5">
                            <Row>
                                <Col
                                    md={{ span: 3, offset: 1 }}
                                    lg={{ span: 2, offset: 2 }} xs={1}></Col>
                                <Col xs={8}><p>Chamber of Commerce: 63464101   &nbsp; &nbsp;     VAT: NL 8552.47.502.B01 &nbsp; &nbsp; <a className="text-decoration-none text-muted" href="#">Terms and conditions </a></p>       </Col>
